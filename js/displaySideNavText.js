...
function noSideNavText() {
	sideNavText = '<div class=\'sideNavTextContent\' id=\'sideNavTextMetrics\'><div id=\'innerTop\'><statUnit>' + leadsValueSum + '</statUnit><statText> in leads</statText></div><br><div id=\'innerBottom\'><statUnitBold>' + leadsCount + '</statUnitBold><statTextBold> leads in these sectors...</statTextBold></div></div>';
	document.getElementById("sideNavTextDiv").innerHTML = sideNavText;
}