...
var addWin, editWin;
var required, banks, regions, stat, arch, sizes, sec, clea;
var sp, pr, co, prt, prn, li, se, ke, prs, pra, br, im, ime, prd, pos, su, subo, sou, fid, ten;
var defaultURL = "http://" + host + "/geoserver/opengeo/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=opengeo%3ADATATABLE";
var searchURL = defaultURL;
var csvURL = "http://" + host + "/geoserver/opengeo/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=opengeo%3ADATATABLE";
...
Ext.onReady(function() {
	...
	var fpControl = new OpenLayers.Control.FeaturePopups({
		...
		sd, {
			templates : {
				...
				//single : '<div class="popupLead"><div class="popupLeadTitle">${.Project_Title}</div><div class="popupLeadDetails"><b>Country: </b>${.Country}<br><b>Sector: </b>${.Sector}<br><b>Date Added: </b>${.Timestamp}<br><b>Primary Funding Source: </b>${.Project_Funding_Source}<br><b>Project Size (USD): </b> ${showPopup()} <br><b>Status: </b>${.Status}<br><b>Archived: </b>${.Archived}<br><br><b>Description: </b><br>${.Project_Description}<br><br><b>Post Comments: </b><br>${.Post_Comments}<br><br><a href=\"${.Link_To_Project}" target="_blank" onclick=\"javascript:ga(\'send\', \'event\', \'External_Link\', \'${.Project_Title}_Lead_Details\', {\'nonInteraction\': 1});\">Project Website</a>&nbsp;<br><a href=\"${.Business_URL}" target="_blank" onclick=\"javascript:ga(\'send\', \'event\', \'Business_Tab_Link\', \'${.Project_Title}_Lead_Details\', {\'nonInteraction\': 1});\">Embassy Website</a><br><a href=\"mailto:${.Submitting_Officer_Contact};\" onclick=\"javascript:ga(\'send\', \'event\', \'Contact\', \'${.Project_Title}_Lead_Details\', {\'nonInteraction\': 1});\">Contact Embassy</a></font></div></div>',
				//single : '<div class="popupLead"><div class="popupLeadTitle">${.Project_Title}</div><div class="popupLeadDetails"><b>Country: </b>${.Country}<br><b>Sector: </b>${.Sector}<br><b>Date Added: </b>${.Timestamp}<br><b>Primary Funding Source: </b>${.Project_Funding_Source}<br><b>Project Size (USD): </b> javascript:numeral(records[0].data.${.Project_Size}).format(\'$0,0[.]00\'); <br><b>Status: </b>${.Status}<br><b>Archived: </b>${.Archived}<br><br><b>Description: </b><br>${.Project_Description}<br><br><b>Post Comments: </b><br>${.Post_Comments}<br><br><a href=\"${.Link_To_Project}" target="_blank" onclick=\"javascript:ga(\'send\', \'event\', \'External_Link\', \'${.Project_Title}_Lead_Details\', {\'nonInteraction\': 1});\">Project Website</a>&nbsp;<br><a href=\"${.Business_URL}" target="_blank" onclick=\"javascript:ga(\'send\', \'event\', \'Business_Tab_Link\', \'${.Project_Title}_Lead_Details\', {\'nonInteraction\': 1});\">Embassy Website</a><br><a href=\"mailto:${.Submitting_Officer_Contact};\" onclick=\"javascript:ga(\'send\', \'event\', \'Contact\', \'${.Project_Title}_Lead_Details\', {\'nonInteraction\': 1});\">Contact Embassy</a></font></div></div>',
				//single : '<div class="popupLead"><div class="popupLeadTitle">${.Project_Title}</div><div class="popupLeadDetails"><b>Country: </b>${.Country}<br><b>Sector: </b>${.Sector}<br><b>Date Added: </b>${.Timestamp}<br><b>Primary Funding Source: </b>${.Project_Funding_Source}<br><b>Project Size (USD): </b> .{numeral(records[0].data.${.Project_Size}).format(\'$0,0[.]00\');} <br><b>Status: </b>${.Status}<br><b>Archived: </b>${.Archived}<br><br><b>Description: </b><br>${.Project_Description}<br><br><b>Post Comments: </b><br>${.Post_Comments}<br><br><a href=\"${.Link_To_Project}" target="_blank" onclick=\"javascript:ga(\'send\', \'event\', \'External_Link\', \'${.Project_Title}_Lead_Details\', {\'nonInteraction\': 1});\">Project Website</a>&nbsp;<br><a href=\"${.Business_URL}" target="_blank" onclick=\"javascript:ga(\'send\', \'event\', \'Business_Tab_Link\', \'${.Project_Title}_Lead_Details\', {\'nonInteraction\': 1});\">Embassy Website</a><br><a href=\"mailto:${.Submitting_Officer_Contact};\" onclick=\"javascript:ga(\'send\', \'event\', \'Contact\', \'${.Project_Title}_Lead_Details\', {\'nonInteraction\': 1});\">Contact Embassy</a></font></div></div>',
				//single : '<div class="popupLead"><div class="popupLeadTitle">${.Project_Title}</div><div class="popupLeadDetails"><b>Country: </b>${.Country}<br><b>Sector: </b>${.Sector}<br><b>Date Added: </b>${.Timestamp}<br><b>Primary Funding Source: </b>${.Project_Funding_Source}<br><b>Project Size (USD): </b>' + $(document).ready(function(){numeral(records[0].data.${.Project_Size}).format('$0,0[.]00)'}; + '<br><b>Status: </b>${.Status}<br><b>Archived: </b>${.Archived}<br><br><b>Description: </b><br>${.Project_Description}<br><br><b>Post Comments: </b><br>${.Post_Comments}<br><br><a href=\"${.Link_To_Project}" target="_blank" onclick=\"javascript:ga(\'send\', \'event\', \'External_Link\', \'${.Project_Title}_Lead_Details\', {\'nonInteraction\': 1});\">Project Website</a>&nbsp;<br><a href=\"${.Business_URL}" target="_blank" onclick=\"javascript:ga(\'send\', \'event\', \'Business_Tab_Link\', \'${.Project_Title}_Lead_Details\', {\'nonInteraction\': 1});\">Embassy Website</a><br><a href=\"mailto:${.Submitting_Officer_Contact};\" onclick=\"javascript:ga(\'send\', \'event\', \'Contact\', \'${.Project_Title}_Lead_Details\', {\'nonInteraction\': 1});\">Contact Embassy</a></font></div></div>',
	...
	var filterPanel = new Ext.FormPanel({
		...
		items : [
			...
			}), cleBox = new Ext.ux.form.CheckboxCombo({
				store : new Ext.data.ArrayStore({
					fields : ['Cleared'],
					data : clea
				}),
				displayField : 'Cleared',
				valueField : 'Cleared',
				mode : 'local',
				emptyText : 'Select Cleared...'
			}), {
				region:'center',
				margins: '0 5 5 5',
				width: 190,
	...
	new Ext.Viewport({
		...
		items : {
			...
			items : [{
				region : 'north',
				html : '<div id="wrap"><div id="header"><div class="row" style="margin: 0px 0px 0px -100px;"><a class="logo" data-bind="click: showHome" href="http://bids.state.gov/index.html"><img id="bidsLogo" alt="BIDS: Business Information Database System, United States Department of State"  src="http://bids.state.gov/img/bidsLogo.png"></a><ul class="nav"><li><a href="mailto:BIDS-Mailbox@state.gov">Contact Us</a></li><li><a href="http://bids.state.gov/help.html">Help</a></li><li><a href="http://bids.state.gov/faqs.html">FAQs</a></li><li><a href="http://bids.state.gov/data.html">Data</a></li><li><a href="javascript:checkTest();">Add a Lead</a></li><li><a href="#">Map</a></li><li><a href="http://bids.state.gov/index.html">Home</a></li></ul></div></div>',
				height : 101,
				boxMinWidth: 900,
				border : true
			}, mapPanel, {
