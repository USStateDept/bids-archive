			searchFunc = function() {
				...
				var cle = cleBox.displayField;
				var cleVal = cleBox.getValue();
				...
				if (cleVal.length > 0) {
					if (cleVal.indexOf(",") != -1) {
						...
						for (var i = 0; i < parts.length; i++) {
							...
							searchFilter = searchFilter + "%3CPropertyIsEqualTo%3E%3CPropertyName%3E" + cle + "%3C/PropertyName%3E%3CLiteral%3E" + parts[i] + "%3C/Literal%3E%3C/PropertyIsEqualTo%3E"
							console.log(searchFilter);
						}
						searchFilter = searchFilter + "</Or>";
						console.log(searchFilter);
						...
						searchFilter = searchFilter + "%3CPropertyIsEqualTo%3E%3CPropertyName%3E" + cle + "%3C/PropertyName%3E%3CLiteral%3E" + cleVal + "%3C/Literal%3E%3C/PropertyIsEqualTo%3E"
					}
					count = count + 1;
				}
...
*/
				...
				ga('send', 'event', 'SearchAdmin_Panel', 'Search_Search_Admin_Panel', {'nonInteraction': 1});
