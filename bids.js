	...
	var fpControl = new OpenLayers.Control.FeaturePopups({
		...
		sd, {
			templates : {
				...
				single : '<div><font size=\"3\"><b>${.PrTitle}</b></font></div>' +  '<div><font size=\"1\" color=\"#909090\"><b>Country: </b>${.Country}' +'<div><font size=\"1\" color=\"#909090\"><b>Sector: </b>${.Sector}'+'<div><font size=\"1\" color=\"#909090\"><b>Data Added: </b>'  + '<br><b>Funding Source: </b>${.PrFSrc}' + '<br><b>Project Size (USD): </b>${.PrSize}' + '<br><b>Description: </b><br><div style="width: 250px; height: 100px; overflow-y: scroll;">${.PrDesc}</div>' +  '<br><a href=\"${.LinkPr}\">Project Website</a>' + '<br><a href=\"mailto:${.SubOffC}\">Contact Embassy</a>' + '</font></div>',
